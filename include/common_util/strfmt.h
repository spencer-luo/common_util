...
/**
 * @brief Align a string to the left with a given width and fill character.
 *
 * @param str the string to be aligned.
 * @param width the width of the aligned string.
 * @param fill the fill character of the aligned string, default is ' '.
 * @return std::string the aligned string.
 */
std::string align_str_left(const std::string& str, int width, char fill = ' ');

/**
 * @brief Align a string to the right with a given width and fill character.
 *
 * @param str the string to be aligned.
 * @param width the width of the aligned string.
 * @param fill the fill character of the aligned string, default is ' '.
 ...
 * If local is true, the function will format the timestamp to local time, otherwise, it will
 * format the timestamp to UTC time.
 * @param fmt the format of the formatted string. useage like std::put_time, see
...
/**
 * @brief Format the system timezone to a string.
 *
 * @return std::string the formatted string.
 */
