...
namespace cutl
{
    ...
    public:
         ...
         * @param max_dot_number: The maximum possible number of dots in the original file
         * extension. For example, it's 1 for .zip, 2 for .tar.gz, and 3 for .min.js.gz.
         * @return std::string The new path
         */
        std::string replace_extension(const std::string& new_extension,
                                      uint8_t max_dot_number = 1) const;
